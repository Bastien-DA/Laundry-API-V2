...
abstract class _$UserDtoCWProxy {
  ...
  UserDto personId(String? personId);
  ...
  /// ````
  UserDto call({String id, String email, num createdAt, String? personId});
}
...
class _$UserDtoCWProxyImpl implements _$UserDtoCWProxy {
  ...
  @override
  UserDto personId(String? personId) => this(personId: personId);
