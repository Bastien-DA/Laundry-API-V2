...
class ProgramApi {
  ...
  Future<Response<void>> programControllerCreateV1({ 
    ...
    try {
_bodyData=jsonEncode(createProgramDto);
  ...
  Future<Response<void>> programControllerEditV1({ 
    ...
    final _path = r'/api/v1/programs/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
_bodyData=jsonEncode(editProgramDto);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> programControllerRemoveV1({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
