...
import 'package:laundry_api_sdk/src/auth/api_key_auth.dart';
import 'package:laundry_api_sdk/src/auth/basic_auth.dart';
import 'package:laundry_api_sdk/src/auth/bearer_auth.dart';
...
class LaundryApiSdk {
  ...
  /// Get LaundryApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
