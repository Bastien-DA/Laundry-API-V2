...
export declare class LaundryService extends AbstractService<LaundryEntity, string, LaundryDto, CreateLaundryDto, EditLaundryDto, LaundryFilterDto> {
    constructor(repo: LaundryRepository, mapper: LaundryMapper);
}
