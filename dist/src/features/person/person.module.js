...
const person_controller_1 = require("./interface/http/person.controller");
const person_service_1 = require("./application/services/person.service");
const person_providers_1 = require("./infrastructure/di/person.providers");
...
exports.PersonModule = PersonModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [person_service_1.PersonService, ...person_providers_1.personProviders],
