...
export declare class UserService extends AbstractService<UserEntity, string, UserDto, CreateUserDto, EditUserDto, UserFilterDto> {
    constructor(repo: UserRepository, mapper: UserMapper);
}
