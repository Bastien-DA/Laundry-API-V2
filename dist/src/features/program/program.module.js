...
const program_controller_1 = require("./interface/http/program.controller");
const program_service_1 = require("./application/services/program.service");
const program_providers_1 = require("./infrastructure/di/program.providers");
...
exports.ProgramModule = ProgramModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [program_service_1.ProgramService, ...program_providers_1.programProviders],
