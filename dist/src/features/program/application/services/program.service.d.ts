...
export declare class ProgramService extends AbstractService<ProgramEntity, string, ProgramDto, CreateProgramDto, EditProgramDto, ProgramFilterDto> {
    constructor(repo: ProgramRepository, mapper: ProgramMapper);
}
