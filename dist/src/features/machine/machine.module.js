...
const machine_controller_1 = require("./interface/http/machine.controller");
const machine_service_1 = require("./application/services/machine.service");
const machine_providers_1 = require("./infrastructure/di/machine.providers");
...
exports.MachineModule = MachineModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [machine_service_1.MachineService, ...machine_providers_1.machineProviders],
